...
- [Design](design.md)
- [Uso](docs/uso.md)
- [Arquitetura implementada](docs/arquitetura-implementada.md)

## Implementação presente neste repositório

O repositório agora contém uma implementação inicial funcional composta por:

- CLI multiplataforma em Node.js (`assinatura` e `simulador`)
- `assinador.jar` em Java, com modo local e modo servidor HTTP
- scripts de build para gerar o jar e preparar os entrypoints do CLI
- testes unitários básicos para o código JavaScript

### Estrutura

- `cli/`: fontes do CLI
- `assinador/`: aplicação Java
- `scripts/`: scripts de build/pacote
